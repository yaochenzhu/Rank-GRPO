...
We have released the SFT checkpoint and on-policy Rank-GRPO (exp_inf) checkpoints for Qwen2.5-0.5B-Instruct and Llama3.1-3B-Instruct as well as the full trainer state.
